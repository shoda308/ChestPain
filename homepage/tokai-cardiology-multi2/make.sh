...
if [ ${UNI} = "KINDAI" ]; then
URL="https://ci02.info.kindai.ac.jp/CardiologyData/indexTokai.php" # for kindai uni
fi
...
if [ ${BUILD} = "DEBUG" ]; then
URL="https://ci02.info.kindai.ac.jp/CardiologyData/indexDebugUI.php" # for debug
fi
