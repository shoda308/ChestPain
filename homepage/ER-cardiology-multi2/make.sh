...
​
if [ ${UNI} = "KINDAI" ]; then
URL="https://ci02.info.kindai.ac.jp/CardiologyData/ERindexUI.kindai.php" # for kindai uni
fi
​
if [ ${BUILD} = "DEBUG" ]; then
URL="https://ci02.info.kindai.ac.jp/CardiologyData/ERindexDebugUI.php" # for debug
fi
​
